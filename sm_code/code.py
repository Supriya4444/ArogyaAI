...
image_path = os.path.join(os.path.dirname(__file__), "stress_relief3.png")
...
st.image("image_path", caption="🌿 The Journey of Your Peaceful Mind Starts Here 🌿", use_container_width=True)
