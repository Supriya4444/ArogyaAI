...
img_path = os.path.join(os.path.dirname(__file__), 'sm_code', 'stress_relief.png')
...
st.image("img_path", caption="🌿 The Journey of Your Peaceful Mind Starts Here 🌿", use_container_width=True)
